/**
 * my-image-button-response
 * Claire Liu (adapted from Josh de Leeuw)
 *
...
jsPsych.plugins["my-image-button-response"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('my-image-button-response', 'stimulus', 'image');
