/**
 * my-canvas-button-response
 * Claire Liu (modified from Josh de Leeuw and Chris Jungerius)
 *
...
jsPsych.plugins["my-canvas-button-response"] = (function () {

    var plugin = {};

    plugin.info = {
        name: 'my-canvas-button-response',
        description: '',
        parameters: {
            stimulus: {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        html += '<canvas id="jspsych-canvas-stimulus" height="' + trial.canvas_size[0] + '" width="' + trial.canvas_size[1] + '"></canvas>' + '</div>';
