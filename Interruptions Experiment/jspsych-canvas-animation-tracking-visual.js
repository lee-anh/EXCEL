...
jsPsych.plugins["canvas-animation-tracking-visual"] = (function () {
  ...
  plugin.info = {
    name: "canvas-animation-tracking-visual",
    ...
    parameters: {
      ...
      stimulus_max_response_time: {
        ...
        default: 90,
        description: 'The maximum response time after the stimulus is shown before a repsone is counted as a miss, in frames per second.'
      },
    ...
    function show_visual_stimulus() {
      ...
      function draw() {
        ...
        if (is_stimulus == true) {
          ...
          if (stimulus[current_trial_number - 1] == trial.choices[0]) { // up 
            // draw up arrow 
          ...
          } else if (stimulus[current_trial_number - 1] == trial.choices[1]) { // down 
            // draw the down arrow
            ctx.fillStyle = 'black';
      ...
      function update() {
        ...
        if (current_time - start_time > duration) {
          ...
          trial_data.accuracy_rt = data_string;
