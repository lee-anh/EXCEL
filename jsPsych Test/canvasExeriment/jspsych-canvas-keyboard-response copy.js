/**
 * jspsych-canvas-object-keyboard-response
 * Claire liu (modified from Chris Jungerius and Josh de Leeuw)
 *
 * a jsPsych plugin for displaying a canvas stimulus and getting a keyboard response, 
 * can pass a canvas object as a parameter
 *
 **/
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      canvas: {
        ...
        pretty_name: 'Canvas Object', 
        default: undefined, 
        description: 'Will be passed as an arguement to the stimulus function'
      },  
