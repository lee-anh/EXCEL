...
jsPsych.plugins["my-audio-button-response"] = (function () {
  var plugin = {};

  jsPsych.pluginAPI.registerPreload('my-audio-button-response', 'stimulus', 'audio');

  plugin.info = {
    name: 'my-audio-button-response',
    description: '',
    parameters: {
      stimulus: {
